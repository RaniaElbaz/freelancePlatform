...
module.exports.putValidator=[
    body("productName").optional().isString().withMessage("productName should be string"),
    body("description").optional().isString().isLength({ min: 100, max: 500 }).withMessage("description must be a String"),
